...
- (void)isInitialized:(CDVInvokedUrlCommand*)command
{
    ...
    [countlyNative onCall: @"isInitialized" commandString: command.arguments callback: ^(NSString * theResult)
     {
        CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString: theResult];
        [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
     }];
...
- (void)getCurrentDeviceId:(CDVInvokedUrlCommand*)command
{
    ...
    [countlyNative onCall: @"getCurrentDeviceId" commandString: command.arguments callback: ^(NSString * theResult)
     {
         CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString: theResult];
         [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
     }];
...
- (void)getDeviceIdAuthor:(CDVInvokedUrlCommand*)command
{
    ...
    [countlyNative onCall: @"getDeviceIdAuthor" commandString: command.arguments callback: ^(NSString * theResult)
     {
         CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString: theResult];
         [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
     }];
...
- (void)giveConsentInit:(CDVInvokedUrlCommand*)command
{
    ...
    [countlyNative onCall: @"giveConsentInit" commandString: command.arguments callback: ^(NSString * theResult)
     {
         CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString: theResult];
         [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
     }];
...
- (void)setStarRatingDialogTexts:(CDVInvokedUrlCommand*)command
{
    ...
    [countlyNative onCall: @"setStarRatingDialogTexts" commandString: command.arguments callback: ^(NSString * theResult)
     {
         CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString: theResult];
         [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
     }];
...
- (void)getFeedbackWidgetData:(CDVInvokedUrlCommand*)command
{
    if(countlyNative == nil){
        countlyNative = CountlyNative.new;
    }
    [countlyNative onCall: @"getFeedbackWidgetData" commandString: command.arguments callback: ^(NSString * theResult)
     {
         CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString: theResult];
         [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
     }];
...
- (void)reportFeedbackWidgetManually:(CDVInvokedUrlCommand*)command
{
    if(countlyNative == nil){
        countlyNative = CountlyNative.new;
    }
    [countlyNative onCall: @"reportFeedbackWidgetManually" commandString: command.arguments callback: ^(NSString * theResult)
     {
         CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString: theResult];
         [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
     }];
...
- (void)replaceAllAppKeysInQueueWithCurrentAppKey:(CDVInvokedUrlCommand*)command
{
    ...
    [countlyNative onCall: @"replaceAllAppKeysInQueueWithCurrentAppKey" commandString: command.arguments callback: ^(NSString * theResult)
     {
         CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString: theResult];
         [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
     }];
...
- (void)removeDifferentAppKeysFromQueue:(CDVInvokedUrlCommand*)command
{
    ...
    [countlyNative onCall: @"removeDifferentAppKeysFromQueue" commandString: command.arguments callback: ^(NSString * theResult)
     {
         CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString: theResult];
         [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
     }];
...
- (void)enableAttribution:(CDVInvokedUrlCommand*)command
{
    ...
    [countlyNative onCall: @"enableAttribution" commandString: command.arguments callback: ^(NSString * theResult)
     {
         CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString: theResult];
         [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
     }];
...
- (void)recordAttributionID:(CDVInvokedUrlCommand*)command
{
    ...
    [countlyNative onCall: @"recordAttributionID" commandString: command.arguments callback: ^(NSString * theResult)
     {
         CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString: theResult];
         [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
     }];
...
- (void)clearAllTraces:(CDVInvokedUrlCommand*)command
{
    ...
    [countlyNative onCall: @"clearAllTraces" commandString: command.arguments callback: ^(NSString * theResult)
     {
         CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString: theResult];
         [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
     }];
...
- (void)recordNetworkTrace:(CDVInvokedUrlCommand*)command
{
    ...
    [countlyNative onCall: @"recordNetworkTrace" commandString: command.arguments callback: ^(NSString * theResult)
     {
         CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString: theResult];
         [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
     }];
...
- (void)enableApm:(CDVInvokedUrlCommand*)command
{
    ...
    [countlyNative onCall: @"enableApm" commandString: command.arguments callback: ^(NSString * theResult)
     {
         CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString: theResult];
         [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
     }];
